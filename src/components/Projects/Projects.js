...
import monopolyGo from "../../Assets/Projects/monopolyGo.png";
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Slime Climb"
              description="Slime Climb is a 2D platformer developed during an intense 72-hour game jam. This year's theme was 'Ascend,' and participants were tasked with creating a speedrunning game. Slime Climb challenges players to climb treacherous heights with agility and precision. It was ranked #50 out of 249 entries, showcasing its engaging gameplay and innovative design."
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={monopolyGo}
              isBlog={false}
              title="Monopoly-Go Bot"
              description="Monopoly-Go Bot is an automation tool designed to play Monopoly Go for you. The bot uses PyAutoGUI to simulate human interactions with the game by recognizing and clicking various buttons. The bot automates the gameplay process by scanning the screen for these buttons, ensuring continuous play without manual input. The project showcases my screen automation, image processing, and exception-handling skills. It demonstrates my ability to integrate third-party libraries to create efficient and user-friendly software solutions."
              ghLink="https://github.com/alihanbays/Monopoly-Go-Bot" 
            />
          </Col>
